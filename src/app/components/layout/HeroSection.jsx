...
const HeroSection = () => {
  return (
    <section id="home" className="text-white py-20 relative overflow-hidden">
      ...
      <div className="absolute right-0 top-0 z-10 opacity-20"> <img src="/ball.svg" alt="Hero" /> </div>
      <div className="absolute left-0 top-0 z-10"> <img src="/tri.svg" alt="Hero" /> </div>
